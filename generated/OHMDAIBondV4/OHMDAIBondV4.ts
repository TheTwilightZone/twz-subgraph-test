...
export class OHMDAIBondV4__adjustmentResult {
  value0: boolean;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class OHMDAIBondV4__bondInfoResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class OHMDAIBondV4__termsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class OHMDAIBondV4 extends ethereum.SmartContract {
  static bind(address: Address): OHMDAIBondV4 {
    return new OHMDAIBondV4("OHMDAIBondV4", address);
  }
  ...
  adjustment(): OHMDAIBondV4__adjustmentResult {
    let result = super.call(
      "adjustment",
    ...
    return new OHMDAIBondV4__adjustmentResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_adjustment(): ethereum.CallResult<OHMDAIBondV4__adjustmentResult> {
    let result = super.tryCall(
      "adjustment",
      "adjustment():(bool,uint256,uint256,uint256,uint256)",
      []
    ...
    return ethereum.CallResult.fromValue(
      new OHMDAIBondV4__adjustmentResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  bondInfo(param0: Address): OHMDAIBondV4__bondInfoResult {
    let result = super.call(
      "bondInfo",
    ...
    return new OHMDAIBondV4__bondInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_bondInfo(
    param0: Address
  ): ethereum.CallResult<OHMDAIBondV4__bondInfoResult> {
    let result = super.tryCall(
      "bondInfo",
      "bondInfo(address):(uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new OHMDAIBondV4__bondInfoResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  terms(): OHMDAIBondV4__termsResult {
    let result = super.call(
      "terms",
    ...
    return new OHMDAIBondV4__termsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_terms(): ethereum.CallResult<OHMDAIBondV4__termsResult> {
    let result = super.tryCall(
      "terms",
      "terms():(uint256,uint256,uint256,uint256,uint256,uint256)",
      []
